...
class AuditLayerProgressionWarhead implements Warhead {
  ...
  private save(): void {
    try {
      ...
      console.error('[audit-layers] Save failed:', e instanceof Error ? e.message : String(e));
    }
  }
  ...
  private load(): void {
    try {
      ...
      console.error('[audit-layers] Load failed:', e instanceof Error ? e.message : String(e));
    }
  }
