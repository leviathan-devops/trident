  ...
  validateLayerContent(layer: number, content: string): { valid: boolean; missing: string[] } {
    ...
    switch (layer) {
      case 1: {
        ...
        const hasReasoning = headings.some((h: string) => h.includes('reasoning'));
      ...
      case 2: {
        ...
        const hasPlan = headings.some((h: string) => h.includes('plan') || h.includes('working'));
      ...
      case 3: {
        ...
        const hasFindings = headings.some((h: string) => h.includes('finding'));
      ...
      case 4: {
        ...
        const hasRCA = headings.some((h: string) => h.includes('root cause') || h.includes('analysis'));
      ...
      case 6: {
        ...
        const hasRegression = headings.some((h: string) => h.includes('regression') || h.includes('prevention'));
