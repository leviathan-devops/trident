...
import { R16_BIBLE_AUDIT } from './layers/r16-bible-enforcement.ts';
...
export class AuditEngine {
  ...
  async auditSingleLayer(targetPath: string, layerId: string): Promise<AuditResult> {
    ...
    const allLayers = [
      ...
      R15_CONTAINER_PREFLIGHT, R16_BIBLE_AUDIT,
      R17_THEATRICAL_INTEGRITY,
    ];
  ...
  private generateReport(result: AuditResult, targetPath: string, projectName: string, agentName: string): string {
    ...
    if (result.sourceFilesScanned === 0) {
      ...
      r += `\n---\n*Generated by Trident AST-Powered Code Review Engine*\n`;
      return r;
    }
    ...
    let report = `# TRIDENT — RUNTIME GRADE DEVOPS AUDIT\n\n`;
    ...
    report += `\n*Generated by Trident AST-Powered Audit Engine*\n`;
